...
enum DemoData {
    ...
    static let sharers: [Sharer] = [
        ...
        Sharer(
            ...
            signatureDrink: coffeeCatalog[6], acceptsTopicSwap: true, weeklySwapLimit: 3, remainingSwapQuota: 1,
            themes: [
    ...
    private static func session(
        ...
        sender: (String, String, String), receiver: UserProfile, theme: ChatTheme, question: String, slots: [String],
        ...
        offeredTheme: (String, String, String)? = nil, receiverQuestion: String? = nil, review: SessionReview? = nil
    ) -> ChatSession {
        ChatSession(id: id, type: type, orderNumber: orderNumber, senderID: sender.0, senderName: sender.1, senderTitle: sender.2, senderAvatarURL: nil, receiverID: receiver.id, receiverName: receiver.name, receiverTitle: "\(receiver.title) @ \(receiver.company)", receiverAvatarURL: receiver.avatarURL, themeID: theme.id, themeTitle: theme.title, themeDescription: theme.description, offeredThemeID: offeredTheme?.0, offeredThemeTitle: offeredTheme?.1, offeredThemeDescription: nil, question: question, offering: offeredTheme?.2, receiverQuestion: receiverQuestion, candidateSlots: slots, confirmedSlot: confirmedSlot, coffeeDrink: drink, price: price, paymentMethod: paymentMethod, paymentDeadline: paymentDeadline, status: status, statusLabel: statusLabel, declineReason: nil, meetingType: "腾讯会议", meetingID: meetingID, meetingLink: receiver.meetingLink, createdAt: createdAt, durationMinutes: 30, review: review, complaintReason: nil)
    }
